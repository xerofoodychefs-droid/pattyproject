...
export const ThermalReceiptModal: React.FC<ThermalReceiptModalProps> = ({
  ...
  const modalContent = (
    <div className="thermal-receipt-print-root thermal-receipt-portal fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 text-black print:p-0 print:m-0 print:bg-white print:static print:block">
      <div className="thermal-receipt-76mm thermal-receipt-80mm bg-white rounded-lg max-w-md w-full p-5 shadow-2xl font-mono text-xs text-left relative max-h-[90vh] overflow-y-auto print:max-h-none print:shadow-none print:rounded-none print:p-0 print:m-0 print:w-[76mm] print:bg-white print:text-black print:static">
